...
static std::string maErrorLevelStr(maErrorLevel lvl){
    switch(lvl){
    case monoAtomic::maErrorLevel::NOERROR: return "NOERROR";
    case monoAtomic::maErrorLevel::WARNING: return "WARNING";
    case monoAtomic::maErrorLevel::ERROR: return "ERROR";
    case monoAtomic::maErrorLevel::CRITICAL: return "CRITICAL";
    case monoAtomic::maErrorLevel::FATAL: return "FATAL";
    }
}
